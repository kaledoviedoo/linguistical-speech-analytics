...
export type Ventana = 'ninguna' | 'corta' | 'razonable';
...
export interface CasoSintetico {
  ...
  /** Que patron del prompt ejercita este caso. */
  nota: string;
  /** true = ambiguo a proposito; se muestra pero no puntua. */
  dificil?: boolean;
}
...
export const CASOS: CasoSintetico[] = [
  ...
  // ------------------------------------------------- limites que faltaban
  {
    ...
    espera: { causal: false, contraste: false, ventana: 'ninguna', score: [0.0, 0.3] },
  ...
  },
  {
    ...
    espera: { causal: true, contraste: true, ventana: 'ninguna', score: [0.1, 0.5] },
  ...
  },
  {
    ...
    espera: { causal: true, contraste: false, ventana: 'ninguna', score: [0.7, 1.0] },
  ...
  },
  {
    ...
    espera: { causal: false, contraste: false, ventana: 'razonable', score: [0.0, 0.25] },
  ...
  },
  {
    ...
    espera: { causal: true, contraste: false, ventana: 'razonable', score: [0.4, 0.75] },
  ...
  },
  {
    ...
    espera: { causal: true, contraste: true, ventana: 'ninguna', score: [0.25, 0.6] },
  ...
  },
  {
    ...
    espera: { causal: false, contraste: true, ventana: 'corta', score: [0.15, 0.5] },
  ...
  // --------------------------------------------------- ambiguos a proposito
  {
    ...
    espera: { causal: true, contraste: false, ventana: 'ninguna', score: [0.4, 0.9] },
  ...
  },
  {
    ...
    espera: { causal: false, contraste: false, ventana: 'ninguna', score: [0.2, 0.6] },
